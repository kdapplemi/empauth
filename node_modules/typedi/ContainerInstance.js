...
var ContainerInstance = /** @class */ (function () {
    ...
    ContainerInstance.prototype.getServiceValue = function (identifier, service) {
        ...
        if (service.factory) {
            ...
            if (service.factory instanceof Array) {
                ...
                service.value = (_a = this.get(service.factory[0]))[service.factory[1]].apply(_a, params);
            }
            else {
                service.value = service.factory.apply(service, params);
            }
        }
        else {
            if (!type)
     ...
     */
    ContainerInstance.prototype.applyPropertyHandlers = function (target) {
        var _this = this;
